...
let finishArrayString = [...strArray1.flatMap(val => val.split(' ')), ...strArray2.flatMap(val => val.split(' '))].join(' ');
console.log(finishArrayString); // Arrays are important data structures for any language and should be mastered in JavaScript.