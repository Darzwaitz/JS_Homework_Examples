...
// alt fat arrow version 
let growthRateSort = [...growthRate].sort((a, b) => a - b);

console.log(growthRateSort); // Array(11) [ -0.4, -0.1, 0.3, 0.3, 0.5, 0.8, 1.1, 1.2, 1.5, 1.5, 2.1 ]
...
// alt fat arrow version
let jMonths = [...months].sort((a, b) =>
    (a.toLowerCase() < b.toLowerCase()) ? -1 :
        (a.toLowerCase() > b.toLowerCase()) ? 1 : 0).splice(4, 3);

console.log(jMonths); // Array(3) [ "January", "July", "June" ]